...
const I18N = {
  ru: {
    ...
    // Hero
    heroBadge: "Новый жилой квартал среди зелени",
    heroHeading: "Квартиры, в которых хочется жить",
    heroText: "Светлые квартиры с отделкой под ключ, закрытые зелёные дворы и всё для комфорта в шаге от дома. Выбирайте планировку и заезжайте.",
    ...
    // Advantages
    advHeading: "Всё для комфортной жизни",
    advSub: "Мы продумали каждую деталь — от зелёных дворов до отделки квартир.",
    adv1Title: "Зелёные дворы",
    adv1Desc: "Ландшафтный дизайн, деревья и зоны отдыха вместо парковок во дворе.",
    adv2Title: "Отделка под ключ",
    adv2Desc: "Заезжайте сразу: чистовая отделка, сантехника и тёплые полы уже внутри.",
    adv3Title: "Безопасность и монолит",
    adv3Desc: "Сейсмостойкость 9 баллов, закрытая территория, видеонаблюдение и консьерж.",
    adv4Title: "Подземный паркинг",
    adv4Desc: "Двухуровневый подземный паркинг с лифтом и гостевые места рядом с домом.",
    adv5Title: "Для детей",
    adv5Desc: "Детские площадки, зоны развития, садик и школа в пешей доступности.",
    adv6Title: "Возврат подоходного налога",
    adv6Desc: "По закону РА ваш налог идет на погашение процентов по ипотеке — экономия до 1.5 млн ֏ в квартал!",

    // About
    aboutBadge: "О комплексе",
    aboutTitle: "Жизнь среди зелени в центре города",
    aboutP1: "Green Project — это современные жилые комплексы с продуманной эко-архитектурой, закрытыми дворами без машин и собственной инфраструктурой. Мы строим дома, в которых приятно жить каждый день: от просторных светлых квартир до уютных прогулочных зон.",
    aboutP2: "Комплекс строится в соответствии с высшими стандартами сейсмостойкости. Доступна выгодная ипотека от 10% взноса и полный возврат подоходного налога от государства.",
    ...
    passportAllDesc: "Сейсмостойкость 9 баллов (монолит), закрытые зелёные дворы без машин, подземные паркинги и полная отделка под ключ.",
    ...
    heroSubtitle: "Девелопер экологичных жилых кварталов в Ереване с отделкой под ключ, закрытыми дворами-парками и государственной поддержкой",
    ...
    projectsSub: "Современная архитектура, экологически чистые районы и максимальный комфорт в Ереване и пригороде",
    ...
    fromPriceLabel: "от",
    standardsHeading: "Стандарты строительства Green Project",
    standardsSub: "Мы строим по строгим экологическим и инженерным стандартам, опережающим время",
  ...
  hy: {
    ...
    heroBadge: "Նոր բնակելի թաղամաս կանաչապատ գոտում",
    heroHeading: "Բնակարաններ, որտեղ հաճելի է ապրել",
    heroText: "Լուսավոր բնակարաններ մաքուր հարդարմամբ, փակ կանաչ բակեր և առավելագույն հարմարավետություն: Ընտրեք ձեր հատակագիծը:",
    ...
    advHeading: "Ամեն ինչ հարմարավետ կյանքի համար",
    advSub: "Մենք մտածել ենք յուրաքանչյուր մանրուք՝ կանաչ բակերից մինչև որակյալ հարդարում:",
    adv1Title: "Կանաչ բակեր",
    adv1Desc: "Լանդշաֆտային դիզայն, ծառեր և հանգստի գոտիներ առանց ավտոմեքենաների:",
    adv2Title: "Մաքուր հարդարում",
    adv2Desc: "Մուտք գործեք միանգամից՝ հատակները, սանտեխնիկան և տաքացվող հատակներն արդեն տեղադրված են:",
    adv3Title: "Անվտանգություն և մոնոլիտ",
    adv3Desc: "9 բալ սեյսմակայունություն, փակ պահպանվող տարածք և տեսահսկում 24/7:",
    adv4Title: "Ստորգետնյա կայանատեղի",
    adv4Desc: "Երկհարկանի ստորգետնյա պարկինգ վերելակով և հյուրերի կայանատեղիներ:",
    adv5Title: "Երեխաների համար",
    adv5Desc: "Խաղահրապարակներ, մանկապարտեզ և դպրոց քայլելու հեռավորության վրա:",
    adv6Title: "Եկամտահարկի վերադարձ",
    adv6Desc: "ՀՀ օրենքով ձեր վճարած հարկն ուղղվում է հիփոթեքի տոկոսներին՝ խնայելով մինչև 1.5 մլն ֏ եռամսյակում:",

    aboutBadge: "Համալիրի մասին",
    aboutTitle: "Կյանք կանաչապատ միջավայրում",
    aboutP1: "Green Project-ը ժամանակակից բնակելի համալիրներ են՝ մտածված էկո-ճարտարապետությամբ և անձնական ենթակառուցվածքներով: Մենք կառուցում ենք տներ, որտեղ հաճելի է ապրել ամեն օր:",
    aboutP2: "Համալիրը կառուցվում է սեյսմակայունության ամենախիստ ստանդարտներով: Գործում է հիփոթեք սկսած 10%-ից և եկամտահարկի 100% վերադարձ:",
    ...
    passportAllDesc: "9 բալ սեյսմակայունություն (մոնոլիտ), փակ կանաչ բակեր առանց մեքենաների, ստորգետնյա պարկինգ և մաքուր հարդարում:",
    ...
    heroSubtitle: "Էկոլոգիական բնակելի թաղամասերի կառուցապատող Երևանում՝ մաքուր հարդարմամբ, փակ բակերով և պետական աջակցությամբ",
    ...
    projectsSub: "Ժամանակակից ճարտարապետություն, էկոլոգիապես մաքուր շրջաններ և առավելագույն հարմարավետություն",
    ...
    standardsHeading: "«Green Project» շինարարական ստանդարտները",
    standardsSub: "Մենք կառուցում ենք խիստ էկոլոգիական և ինժեներական ստանդարտներով",
  ...
  en: {
    ...
    heroBadge: "Modern residential quarter surrounded by greenery",
    heroHeading: "Homes where you truly want to live",
    heroText: "Bright turnkey apartments, private green courtyards and everything you need for comfort just a step away from home.",
    ...
    advHeading: "Everything for Comfortable Living",
    advSub: "We thought through every detail — from green courtyards to interior finishing.",
    adv1Title: "Green Courtyards",
    adv1Desc: "Landscape design, trees, and lounge areas instead of parking in the courtyard.",
    adv2Title: "Turnkey Finishing",
    adv2Desc: "Move in immediately: fine finishing, sanitary ware, and underfloor heating already included.",
    adv3Title: "Safety & Monolithic Frame",
    adv3Desc: "Magnitude 9 seismic safety, gated territory, 24/7 security, and concierge service.",
    adv4Title: "Underground Parking",
    adv4Desc: "Dual-level underground parking with elevator access and guest parking slots.",
    adv5Title: "For Children",
    adv5Desc: "Modern playgrounds, developmental zones, kindergarten, and school in walking distance.",
    adv6Title: "Income Tax Refund",
    adv6Desc: "Under Armenian law, your income tax covers your mortgage interest — saving up to 1.5M ֏ per quarter!",

    aboutBadge: "About Complex",
    aboutTitle: "Living in greenery in the heart of the city",
    aboutP1: "Green Project represents modern residences designed with eco-conscious architecture, private car-free parks, and integrated infrastructure. We build homes where everyday life is a pleasure.",
    aboutP2: "Constructed to highest seismic engineering standards. Favorable mortgage options from 10% down payment and 100% income tax refund are available.",
    ...
    passportAllDesc: "Magnitude 9 seismic safety, private car-free parks, underground parking, and turnkey finish.",
    ...
    heroSubtitle: "Developer of sustainable residential quarters in Yerevan with turnkey finish, private parks, and state subsidy",
    ...
    projectsSub: "Contemporary architecture, eco-friendly districts, and maximum comfort in Yerevan and suburbs",
    ...
    fromPriceLabel: "from",
    standardsHeading: "Green Project Construction Standards",
    standardsSub: "We build to strict ecological and engineering standards that lead the industry",
